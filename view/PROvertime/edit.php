        ...
        <div class="row">
            <div class="col-12">
                <div class="card">
                    ...
                    <div class="card-body">
                        <form id="overtimeForm" action="../../action/PROvertime/update.php" method="POST" >
                            <input type="hidden" name="id" value="<?php echo $overtime['ID']; ?>">
                            <div class="row">
                                <div class="col-md-6">
                                    <div class="mb-3">
                            ...
                            <div class="row">
                                <div class="col-md-6">
                                    <div class="mb-3">
                                        ...
                                        <input type="date" class="form-control" id="overtimeDate" name="overtimeDate" required value="<?php echo $overtime['OTDate']; ?>">
                                    </div>
                                </div>
                                <div class="col-md-6">
                                    <div class="mb-3">
                                        ...
                                        <select class="form-select" id="overtimeType" name="overtimeType" required>
                                            ...
                                            <option value="OFF" <?php if($overtime['OTType']=='OFF'){echo "selected";} ?>>Day Off</option>
                                            <option value="OT" <?php if($overtime['OTType']=='OT'){echo "selected";} ?>>Overtime</option>
                                            <option value="PH" <?php if($overtime['OTType']=='PH'){echo "selected";} ?>>PH Holiday</option>
                                        </select>
                                    </div>
                                </div>
                            </div>
                            <div class="row">
                                <div class="col-md-6">
                                    <div class="mb-3">
                                        ...
                                        <input type="time" class="form-control" id="fromTime" name="fromTime" required value="<?php echo $overtime['FromTime']; ?>">
                                    </div>
                                </div>
                                <div class="col-md-6">
                                   <div class="mb-3">
                                        <label for="overtimeDate" class="form-label required">To Time</label>
                                        <input type="time" class="form-control" id="toTime" name="toTime" required value="<?php echo $overtime['ToTime']; ?>">
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="row">
                                ...
                                <div class="col-md-12">
                                    <div class="mb-3">
                                       ...
                                       <textarea name="reason" class="form-control" id="" cols="30" rows="10"><?php echo $overtime['Reason']; ?></textarea>
                                    </div>
                                </div>
                            </div>
                            <div class="text-end">
