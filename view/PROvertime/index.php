                    ...
                    <div class="card-body">
                        <table id="careerHistoryTable" class="table table-striped table-hover">
                            ...
                            <tbody>
                                ...
                                $sql = "SELECT 
                                    PR.*,
                                    P.Description AS PositionDes,
                                    SP.EmpName 
                                    FROM `provertime` PR
                                    INNER JOIN hrstaffprofile SP ON PR.Empcode = SP.EmpCode
                                    INNER join hrposition P ON SP.Position = P.Code
                                    ORDER BY PR.ID DESC";
                                $result = $con->query($sql);
                                while ($row = $result->fetch_assoc()): ?>
                                    <tr>
                                        ...
                                        <td><?php echo htmlspecialchars($row['OTDate'] ?? ''); ?></td>
                                        <td><?php echo htmlspecialchars($row['FromTime'] ?? ''); ?></td>
                                        <td><?php echo htmlspecialchars($row['ToTime'] ?? ''); ?></td>
